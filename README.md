...
* **CSS3 & Tailwind CSS:** Estilização moderna, responsiva e layout adaptável para celulares e computadores.
* **JavaScript:** Interatividade básica e carregamento dinâmico.
* **Lucide Icons & Font Awesome:** Ícones visuais para melhor experiência do usuário (UI/UX).
* **Google Fonts:** Tipografia (*DM Sans* / *Montserrat*).
